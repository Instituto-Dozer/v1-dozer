                        ...
                        <tbody>
                            ...
                            foreach ($blogs->result_array() as $key => $blog) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $this->crud_model->get_blog_categoria($blog['blog_category_id'])->row('title'); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="<?php echo site_url('user/edit_blog/' . $blog['blog_id']) ?>"><?php echo get_phrase('edit'); ?></a></li>
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('user/blog/status/' . $blog['blog_id']); ?>');">
                                                	<?php if($blog['status'] == 1){echo get_phrase('deactivate'); }else{ echo get_phrase('activate'); } ?>
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('user/blog/delete/' . $blog['blog_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
