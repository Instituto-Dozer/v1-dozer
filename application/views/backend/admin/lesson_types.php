...
<div class="mt-3">
    <div class="custom-control custom-radio">
        <input type="radio" id="vdocipher" name="lesson_type" class="custom-control-input" value="vdocipher" <?php if ($selected_lesson == 'vdocipher') echo 'checked'; ?>>
        <label class="custom-control-label" for="vdocipher">VdoCipher <?php echo get_phrase('video'); ?></label>
    </div>

    <div class="custom-control custom-radio">
        <input type="radio" id="dyntube" name="lesson_type" class="custom-control-input" value="dyntube" <?php if ($selected_lesson == 'dyntube') echo 'checked'; ?>>
        <label class="custom-control-label" for="dyntube">DynTube <?php echo get_phrase('video'); ?></label>
    </div>
    ...
    <div class="mt-3">
        <a href="javascript::void(0)" type="button" class="btn btn-primary" data-toggle="modal" data-dismiss="modal" id="lesson-add-modal" onclick="showLessonAddModal()"><?php echo get_phrase('next'); ?></a>
    </div>
</div>
