...
if ($selected_category_id == 0) {
    foreach ($categoria->result_array() as $category) {
        $selected_category_id = $category['id'];
        $sub_categoria = $this->db->get_where('category', array('parent' => $selected_category_id));
        break;
    }
}else {
    $sub_categoria = $this->db->get_where('category', array('parent' => $selected_category_id));
}
$selected_category_details = $this->crud_model->get_categoria($selected_category_id)->row_array();
?>
<hr />
<ol class="breadcrumb bc-3">
    ...
    <li><a href="<?php echo site_url('admin/categoria'); ?>"><?php echo get_phrase('categoria'); ?></a> </li>
    <li><a href="#" class="active"><?php echo get_phrase('sub_categoria'); ?></a> </li>
</ol>
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
                <div class="row">
                    <form class="" action="<?php echo site_url('admin/sub_categoria_by_category_id'); ?>" method="post">
                ...
                <table class="table table-bordered datatable" id="table-1">
                    ...
                    <tbody>
                        <?php foreach ($sub_categoria->result_array() as $sub_category): ?>
                            <tr class="gradeU">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#" onclick="confirm_modal('<?php echo site_url('admin/sub_categoria/'.$selected_category_id.'/delete/'.$sub_category['id']); ?>');">
