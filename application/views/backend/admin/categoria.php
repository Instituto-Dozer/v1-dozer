<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('categoria'); ?>
...
<div class="row">
    <?php foreach ($categoria->result_array() as $category) :
            ...
            <div class="card d-block">
                ...
                <div class="card-body">
                    ...
                    <small style="font-style: italic;">
                        <p class="card-text"><?php echo count($sub_categoria) . ' ' . get_phrase('sub_categoria'); ?></p>
                    </small>
                </div>

                <ul class="list-group list-group-flush">
                    <?php foreach ($sub_categoria as $sub_category) : ?>
                        <li class="list-group-item on-hover-action" id="<?php echo $sub_category['id']; ?>">
                            ...
                            <span class="category-action" id='category-delete-btn-<?php echo $sub_category['id']; ?>' style="float: right; margin-left: 5px; display: none; height: 20px;">
                                <a href="javascript:;" class="action-icon" onclick="confirm_modal('<?php echo site_url('admin/categoria/delete/' . $sub_category['id']); ?>');"> <i class="mdi mdi-delete" style="font-size: 18px;"></i></a>
                            </span>
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-icon btn-outline-danger btn-sm" id="category-delete-btn-<?php echo $category['id']; ?>" style="float: right; display: none;" onclick="confirm_modal('<?php echo site_url('admin/categoria/delete/' . $category['id']); ?>');" style="margin-right:5px;">
