                                                        ...
                                                        <select class="form-control select2" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                            ...
                                                            <?php foreach ($categoria->result_array() as $category) : ?>
                                                                <optgroup label="<?php echo $category['name']; ?>">
                                                                    <?php $sub_categoria = $this->crud_model->get_sub_categoria($category['id']);
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="telegram_url" name="telegram_url" value="<?php echo $course_details['url_telegram']; ?>" placeholder="Añadir url telegram" required>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
