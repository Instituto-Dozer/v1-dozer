    ...
    <div class="container">
        <div class="row">
                ...
                <div class="user-dashboard-sidebar box-shadow-5">
                    ...
                    <div class="user-dashboard-menu">
                        <ul>
                            ...
                            <li class="active mb-3"><a href="<?php echo site_url('home/profile/user_mis_cursos'); ?>"> <i class="	fas fa-graduation-cap"></i> <?php echo site_phrase('cursos'); ?></a></li>
            ...
            <div class="col-md-8 col-lg-9 mt-4 mt-md-0">
                <?php
                $my_courses = $this->user_model->my_courses_c()->result_array();
                if ($my_courses == null) {
                ?>
