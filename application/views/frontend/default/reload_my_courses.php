        ...
        <div class="pb-3" id="course_info_view_<?php echo $course_details['id'];  ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-12 px-4 py-1">
              <a href="<?php echo site_url('home/lesson/' . rawurlencode(slugify($course_details['title'])) . '/' . $course_details['id']); ?>" class="btn red radius-5 w-100"><?php echo site_phrase('start_lesson'); ?></a>
            </div>
          </div>
        </div>
