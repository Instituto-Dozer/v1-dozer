<?php
    $popular_categoria = $this->crud_model->get_categoria_with_blog_number(6);
...
<div style="position: sticky; top: 20px;" class="py-2">
    ...
    <h6 class="m-0 px-2 pt-5 pb-3 fw-700 border-bottom"><?php echo site_phrase('popular_categoria'); ?></h6>
    <div class="list-group">
        <?php foreach($popular_categoria as $popular_category): ?>
            <?php $blog_category = $this->crud_model->get_blog_categoria($popular_category['blog_category_id'])->row_array(); ?>
        ...
        <?php endforeach; ?>
        <a class="text-14px ps-2 my-2 text-muted" href="<?php echo site_url('blog/categoria'); ?>"><?php echo site_phrase('all_categoria'); ?></a>
    </div>
