                        ...
                        <div class="course-curriculum-accordion">
                            ...
                            foreach ($sections as $key => $section) : ?>
                                <div class="lecture-group-wrapper">
                                    ...
                                    <div class="lecture-group-title clearfix my-3 fondo-lecciones fw-bold" style="<?= $style; ?>" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?php if ($counter == 0) echo 'true'; ?>">
                                        ...
                                        <ul>
                                            ...
                                            foreach ($lessons as $lesson) : ?>
                                                <li class="lecture has-preview text-14px ">
                                                    <span class="lecture-title text-white <?php if ($lesson['is_free'] == 1) echo 'text-primary'; ?>" onclick="go_course_playing_page('<?php echo $course_details['id']; ?>', '<?php echo $lesson['id']; ?>')"><?php echo $lesson['title']; ?></span>
                        ...
                        <?php foreach ($instructors as $key => $instructor) : ?>
                            ...
                            <div class="row justify-content-center mb-3">
                                ...
                                <div class="col-md-8 py-0 px-3 text-center text-md-start">
                                    <h4 class="mb-1 fw-600 "><a class="about-directora-nombre" href="<?php echo site_url('home/instructor_page/' . $instructor['id']); ?>"><?php echo $instructor['first_name'] . ' ' . $instructor['last_name']; ?></a>
                                    </h4>
                ...
                <div class=" mt-5 pb-3">
                    ...
                    <div class="row fondo-certificado-cursos mt-5">
                        <div class="col-6 p-2000">
                            <div class="d-flex flex-row mb-3">
                                <div class=""><img class="w-19px position-absolute" src="<?= base_url() ?>uploads/system/icon-sheck.png" alt=""></div>
                                <div class="">
                    ...
                    <div class="  mt-5 ">
                        <div class="d-flex cg-1rem fondo-certificado-cursos">
                            ...
                            <div class="p-2 flex-shrink-1   "><img class="w-70px" src="<?= base_url() ?>uploads/system/capacitacion.png " alt=""></div>
                        ...
                        <div class="d-flex cg-1rem ">
                            ...
                            <div class="p-2 flex-shrink-1 px-5 py-3  fondo-insignia"><img class="img-insignia" src="<?= base_url() ?>uploads/system/certificados/insignia.png " alt=""></div>
                        ...
                        <div class="d-flex flex-row fondo-reconocimiento">
                            ...
                            <div class="py-2 margin-reconocimiento">
                                ...
                                <div class=" mb-3 align-items-center justify-content-center ">
                                    <div class="p-2"> <img class="img-reconocimiento" src="<?= base_url() ?>uploads/system/logo-reconocimiento.png " alt=""></div>
                ...
                <div class="course-sidebar box-shadow-5 natural cuadro-contenido">
                    ...
                    <div class="course-sidebar-text-box">
                        ...
                        <?php else : ?>
                            ...
                            <?php else : ?>
                                <div class="buy-btns">
                                    ...
                                    <button class="btn btn-buy-now" type="button" id="<?php echo $course_details['id']; ?>" onclick="handleCartItems(this)"> <img class="card-course" src="<?= base_url() ?>uploads/system/card-white.png " alt=""> <?php echo site_phrase('Agregar a mi carrito'); ?></button>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <div class="includes">
                            ...
                            <ul>
                                <?php if ($course_details['course_type'] == 'general') : ?>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Docente con amplia
                                        experiencia</li>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Clases a tu ritmo, inicia cuando
                                        quieras
                                    </li>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Certificado por
                                        Instituto Dozer
                                    </li>
                                ...
                                <?php endif; ?>
                                <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Proyectos reales
                                    desde cero
                                </li>
                                <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Constancia de
                                    matrícula
                                </li>
                                <?php
                            ...
                            <a href="" class="brochure text-center text-white">¡Quiero ser <span> <img class="w-20-px" src="<?= base_url() ?>uploads/system/corona-white.png " alt=""> </span> Premium!</a>
                            <div class="title text-white">
                                <b><?php echo site_phrase('Beneficios de ser Premium'); ?>:</b>
                            </div>
                            <ul>
                                <?php if ($course_details['course_type'] == 'general') : ?>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Acceso total a los
                                        26 cursos</li>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Acceso a todos los
                                        certificados de los
                                ...
                                <?php endif; ?>
                                <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Asesoría para la
                                    instalación de los
                                    softwares de autodesk
                                </li>
                                <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Asesoría académica
                                    exclusiva y más!
                                </li>
                                <?php
                                if (addon_status('affiliate_course')) : // course_addon start  adding
                            ...
                            <div class="d-flex flex-row mb-3 align-items-center justify-content-center fondo-wts">
                                <div class="p-2"> <a href="#"> <img class="w-20-px" src="<?= base_url() ?>uploads/system/whatsap.svg " alt="">
