    ...
    <div class="text-center mt-5 mx-3">
        <div class="progress" style="height: 5px;">
            <div class="progress-bar progress-bar-striped bg-progress" role="progressbar"
                ...
                aria-valuenow="<?php echo course_progress($course_details['id']); ?>" aria-valuemin="0"
        ...
        <div class="col-12">
            ...
            <div class="tab-content" id="lessonTabContent">
                        ...
                        <div class="card " style="margin:0px 0px;">
                            <div class="card-header course_card-dos" id="<?php echo 'heading-'.$section['id']; ?>">
                                ...
                                <button class="btn btn-link w-100 text-start d-grid" type="button"
                                    ...
                                    data-bs-target="<?php echo '#collapse-'.$section['id']; ?>"
                                    <?php if($opened_section_id == $section['id']): ?> aria-expanded="true"
                                    ...
                                    onclick="toggleAccordionIcon(this, '<?php echo $section['id']; ?>')">
                                    <p class="w-100" style="color: white;font-size: 15px;margin: 0 0 0 !important;">
                                        ...
                                        <span style="float: right; font-weight: 100;" class="accordion_icon"
                                            id="accordion_icon_<?php echo $section['id']; ?>">
                            ...
                            <div id="<?php echo 'collapse-'.$section['id']; ?>"
                                class="collapse <?php if($section_id == $section['id']) echo 'show'; ?>"
                                aria-labelledby="<?php echo 'heading-'.$section['id']; ?>"
                                        ...
                                        <tr
                                            ...
                                            <td style="text-align: left; padding:0px 10px;">
                                                ...
                                                <span data-toggle="tooltip"
                                                    title="<?php echo site_phrase('completed'); ?>"><i
                                                        class="far fa-check-square text-success text-14px"></i></span>
                                                <?php else: ?>
                                                <span data-toggle="tooltip"
                                                    title="<?php echo site_phrase('play'); ?>"><i
                                                        class="far fa-play-circle text-muted text-14px"></i></span>
                                                <?php endif; ?>
                                                <?php else: ?>
                                                <?php if($lesson_id == $lesson['id']) $show_locked_message = 1; ?>
                                                <span data-toggle="tooltip"
                                                    title="<?php echo site_phrase('watch_the_previous_lesson_to_unlock'); ?>"><i
                                                        class="fas fa-lock text-muted text-14px"></i></span>
                                                <?php endif; ?>
                                                <?php else: ?>
                                                <div class="form-group form-group-dos">
                                                    <input type="checkbox" id="<?php echo $lesson['id']; ?>"
                                                        onchange="markThisLessonAsCompleted(this.id);" value=1
                                                        <?php if($lesson_progress == 1):?> checked <?php endif; ?>>
                ...
                <div class="tab-pane fade" id="certificate" role="tabpanel" aria-labelledby="certificate-tab"
                    ...
                    <div class="circular-progressdiv" id="course_progress_area"
                        data-percent="<?php echo course_progress($course_id); ?>">
                    ...
                    <div id="download_certificate_area" style="padding: 15px;">
                        <?php if (addon_status('certificate')): ?>
                        <a href="#" target="_blank" class="btn btn-primary" id="certificate_download_btn"
                            disabled><?php echo get_phrase('get_certificate'); ?></a>
                        <?php else: ?>
                        <a href="#" target=""
                            class="btn btn-primary"><?php echo get_phrase('install_certificate_addon_first'); ?></a>
                        <?php endif; ?>
                    </div>
