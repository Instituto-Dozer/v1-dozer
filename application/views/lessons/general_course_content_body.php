<div class="width-lesson order-1 course_col" id="video_player_area">
        ...
        <div class="">
            ...
            ?>
                ...
                <?php if (strtolower($provider) == 'youtube') : ?>
                    ...
                    <!-- If the video is vdocipher video -->
                <?php elseif (strtolower($provider) == 'vdocipher') : ?>
                    <!------------- PLYR.IO ------------>
                    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/plyr/plyr.css">
                    <?php
                    $result = getOTP($video_url);
                    ?>
                    <div class="plyr__video-embed">
                        <iframe height="500" src="https://player.vdocipher.com/v2/?otp=<?= $result['otp']; ?>&playbackInfo=<?= $result['playbackInfo']; ?>" allow="encrypted-media" allowfullscreen allowtransparency allow="autoplay"></iframe>
                    </div>
                    ...
                    <!-- If the video is dyntube video -->
                <?php elseif (strtolower($provider) == 'dyntube') : ?>
                    <!------------- PLYR.IO ------------>
                    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/plyr/plyr.css">

                    <div class="plyr__video-embed" >
                        <iframe  height="500" src="<?= $video_url; ?>" allowfullscreen allowtransparency allow="autoplay"></iframe>
                    </div>
