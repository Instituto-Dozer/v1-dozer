...
class Crud_model extends CI_Model
{
    ...
    public function get_sub_categoria($parent_id = "")
    {
    ...
    function get_top_categoria($limit = "10", $category_column = "category_id")
    {
        $query = $this->db
    ...
    {
        $categoria = $this->get_categoria()->result_array();
    ...
    {
        $sub_categoria = $this->get_sub_categoria($default_cateegory_id);
    ...
    function get_blog_categoria($blog_category_id = "")
    {
    ...
    function get_categoria_with_blog_number($limit = 10)
    {
        $query = $this->db
