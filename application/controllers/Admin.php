...
class Admin extends CI_Controller
{
    ...
    public function categoria($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add') {
            ...
            redirect(site_url('admin/categoria'), 'refresh');
        } elseif ($param1 == "edit") {
        ...
        $page_data['page_name'] = 'categoria';
        $page_data['page_title'] = get_phrase('categoria');
        $page_data['categoria'] = $this->crud_model->get_categoria($param2);
        $this->load->view('backend/index', $page_data);
    }
    ...
    public function category_form($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add_category") {
            ...
            $page_data['categoria'] = $this->crud_model->get_categoria()->result_array();
    ...
    public function sub_categoria_by_category_id($category_id = 0)
    {
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        redirect(site_url("admin/sub_categoria/$category_id"), 'refresh');
    }
    ...
    public function sub_category_form($param1 = "", $param2 = "")
    {
        ...
        $page_data['categoria'] = $this->crud_model->get_categoria();
        $this->load->view('backend/index', $page_data);
    }
    ...
    {
        $page_data['sub_categoria'] = $this->crud_model->get_sub_categoria($category_id);
    ...
    function blog_category($param1 = "", $param2 = "")
    {
        ...
        $page_data['categoria'] = $this->crud_model->get_blog_categoria();
