...
class Api extends REST_Controller {
  ...
  // Fetch all the categoria
  public function all_categoria_get() {
    $categoria = array();
    $categoria = $this->api_model->all_categoria_get();
    $this->set_response($categoria, REST_Controller::HTTP_OK);
  }

  public function categoria_get($category_id = "") {
    $categoria = array();
    $categoria = $this->api_model->categoria_get($category_id);
    $this->set_response($categoria, REST_Controller::HTTP_OK);
  }
  // Fetch all the categoria
  public function sub_categoria_get($parent_category_id = "") {
    $categoria = array();
    $categoria = $this->api_model->sub_categoria_get($parent_category_id);
    $this->set_response($categoria, REST_Controller::HTTP_OK);
  }
